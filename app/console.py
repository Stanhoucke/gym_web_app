...
workout_1 = Workout("Just Skate", "freestyle", datetime.date(2020, 12, 16), datetime.time(6, 15), 2)
workout_repository.save(workout_1)
workout_2 = Workout("Double Poling", "classic", datetime.date(2020, 12, 10), datetime.time(10,30), 3)
...
# workout_2 = Workout("Double Poling", "classic", datetime.date(2020, 12, 10), datetime.time(10,30), 3, id=25)
