...
workout_1 = Workout("Just Skate", "freestyle", True, datetime.date(2020, 12, 16), "08:00")
workout_repository.save(workout_1)
workout_2 = Workout("Double Poling", "classic", False, datetime.date(2020, 12, 10), "14:00")
